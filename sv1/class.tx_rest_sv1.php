...
/**
 * Service "BE authentification though HTTP-auth" for the "rest" extension.
 *
 * @author	Niels Fröhling <niels@frohling.biz>
 * @package	TYPO3
 * @subpackage	tx_rest
 */
class tx_rest_sv1 extends tx_sv_authbase {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/rest/sv1/class.tx_rest_sv1.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/rest/sv1/class.tx_rest_sv1.php']);
}
